    ...
    <div className="w-full">
      <div className="rounded-lg w-[100%] mx-auto bg-white pt-3 pb-1">
        <div className="w-[95%] mx-auto">
          <StartPost>
            ...
            />
            <div className="border-[1px] border-gray-400 rounded-full p-4 text-gray-500 bg-gray-100 font-bold cursor-pointer">
              start a post
            </div>
          </StartPost>
      ...
      <div className=" bg-white">
        ...
        <div className="text-gray-500 text-sm">
          ...
          <div className="bg-pexel-img h-[500px] w-full bg-no-repeat bg-center bg-cover"></div>
